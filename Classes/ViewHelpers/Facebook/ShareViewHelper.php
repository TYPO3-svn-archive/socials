 ...
 * Examples
 * ==============
 * <socials:facebook.share>Share</n:social.facebook.share>
 * Result: Facebook widget to share current URL with the text "Share"
 *
 * @package TYPO3
 * @subpackage tx_socials
 */
class Tx_Socials_ViewHelpers_Facebook_ShareViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractTagBasedViewHelper {
