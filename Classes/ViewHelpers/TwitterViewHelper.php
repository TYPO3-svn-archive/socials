 ...
 *
 * <socials:twitter datacount="vertical" datalang="de"
 * dataurl="http://www.mydomain.tld">Twitter</socials:twitter>
 * Result: Twitter widget to share www.mydomain.tld with a german twitter text
 *
 * @package TYPO3
 * @subpackage tx_Socials
 */
class Tx_Socials_ViewHelpers_TwitterViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractTagBasedViewHelper {
	/**
	 * @var	string
	 */
	protected $tagName = 'a';
