 ...
 * ==============
 *
 * <socials:googlePlus></socials:googlePlus>
 * Result: Google Plus Button
 *
 * <socials:googlePlus size="small"  href="http://www.mydomain.tld" count="false"></n:social.googlePlus>
 * Result: Small Google Plus Button to share www.mydomain.tld without showing the counter
 *
 * @package TYPO3
 * @subpackage tx_Socials
 */
class Tx_Socials_ViewHelpers_GooglePlusViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractTagBasedViewHelper {
