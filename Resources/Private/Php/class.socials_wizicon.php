 ...
 * @subpackage tx_news
 */
class socials_pi1_wizicon {
	protected $extKey = 'socials';
	...
	public function proc($wizardItems) {
		...
		$wizardItems['plugins_tx_' . $this->extKey] = array(
			'icon'			=> t3lib_extMgm::extRelPath($this->extKey) . 'Resources/Public/Icons/wizard_icon.png',
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/socials/Resources/Private/Php/class.socials_wizicon.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/socials/Resources/Private/Php/class.socials_wizicon.php']);
}
